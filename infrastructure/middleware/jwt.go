...
//type Condition func(claims *authenticator.Claims, r *http.Request) bool
//
//// JWTAuthenticate is a JWT Authentication middleware operation.
//func (m *Middleware) JWTAuthenticate(w http.ResponseWriter, r *http.Request, params httprouter.Params) bool {
...
//	return func(w http.ResponseWriter, r *http.Request, params httprouter.Params) bool {
//		// Attempting to get access token claims from the request context
//		claims := authenticator.NewClaims(r.Context().Value(m.Options.JWTContextKey))
//		if claims == nil {
